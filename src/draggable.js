    ...
    */
    ...
    util.assign (Draggable.prototype, {
        ...
        initialize: function() {
            ...
            util.on(window, me.handlers.resize);
        ...
        resize: function (e) {
            var me = this,
                ...
                x = dimentions.x,
                y = dimentions.y;
            me.setLimit(me.options.limit);
            me.move(x, y, x, y);
        },

        move: function (x, y, posx, posy) {
            ...
            var me = this,
                ...
                pos = me.limit(x, y, posx===undefined?dragEvent.original.x:posx, posy===undefined?dragEvent.original.y:posy);
            if(pos.x<0){
                pos.x = 0;
            }
            if(pos.y<0){
        ...
        destroy: function () {
            ...
            util.off(window, this.handlers.resize);
